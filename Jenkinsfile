...
try{
    ...
    stage('SonarQube Analysis-2') {
         ...
         //withSonarQubeEnv(installationName:'sonarqube') {
            ...
            sh 'docker run --rm -e SONAR_HOST_URL="http://3.134.62.65:9000" -e SONAR_SCANNER_OPTS="-Dsonar.projectKey=saiveerateja-3 -Dsonar.working.directory=/home/ubuntu/sonarworkspace" -e SONAR_TOKEN=sqp_fb5ec4abfc59ef60029cb0a2d9635515fbf019e0 -v .:/usr/src -v .:/usr/src/.scannerwork sonarsource/sonar-scanner-cli'
        }
